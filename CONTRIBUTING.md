...
This project would not exist without its contributors, and we welcome you to join us in our endeavor. This guide is
intended for anyone who wants to contribute to the [Ansible Server Harden role][project-url]. Please read this
...
* What version of this project you are using
* What you did
...
```bash
git remote add upstream https://github.com/andrewvaughan/ansible-role-server-harden
```
...
[project-url]:    https://github.com/andrewvaughan/ansible-role-server-harden
[license-url]:    https://github.com/andrewvaughan/ansible-role-server-harden/blob/master/LICENSE
[issues-url]:     https://github.com/andrewvaughan/ansible-role-server-harden/issues
[milestones-url]: https://github.com/andrewvaughan/ansible-role-server-harden/milestones
[pulls-url]:      https://github.com/andrewvaughan/ansible-role-server-harden/pulls
